...
VL_ATTR_COLD void VSingleCycleCPU___024root__trace_init_sub__TOP__0(VSingleCycleCPU___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+3,"readData1", false,-1, 31,0);
    tracep->declBus(c+4,"readData2", false,-1, 31,0);
    tracep->declBus(c+5,"imm", false,-1, 31,0);
    tracep->declBus(c+6,"ALUSrcB", false,-1, 31,0);
    tracep->declBus(c+58,"ALUOut", false,-1, 31,0);
    tracep->declBus(c+95,"memData", false,-1, 31,0);
    tracep->declBus(c+96,"writeData", false,-1, 31,0);
    tracep->declBus(c+7,"branchAddr", false,-1, 31,0);
    tracep->declBus(c+8,"PCPlus4", false,-1, 31,0);
    tracep->declBus(c+9,"branchTarget", false,-1, 31,0);
    ...
    tracep->declBus(c+14,"ALUCtl", false,-1, 3,0);
    tracep->declBus(c+15,"funct3", false,-1, 2,0);
    tracep->declBus(c+16,"memtoReg", false,-1, 1,0);
    tracep->declBus(c+17,"ALUOp", false,-1, 1,0);
    tracep->declBus(c+18,"PCSel", false,-1, 1,0);
    tracep->declBit(c+59,"memRead", false,-1);
    tracep->declBit(c+19,"memWrite", false,-1);
    tracep->declBit(c+20,"ALUSrc", false,-1);
    tracep->declBit(c+21,"regWrite", false,-1);
    tracep->declBit(c+22,"BrEq", false,-1);
    tracep->declBit(c+23,"BrLT", false,-1);
    ...
    tracep->declBus(c+9,"sum", false,-1, 31,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+58,"s2", false,-1, 31,0);
    ...
    tracep->declBus(c+8,"s2", false,-1, 31,0);
    ...
    tracep->declBit(c+62,"rst", false,-1);
    tracep->declBit(c+21,"regWrite", false,-1);
    tracep->declBus(c+12,"readReg1", false,-1, 4,0);
    tracep->declBus(c+13,"readReg2", false,-1, 4,0);
    ...
    tracep->declBus(c+7,"o", false,-1, 31,0);
...
VL_ATTR_COLD void VSingleCycleCPU___024root__trace_full_sub_0(VSingleCycleCPU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+2,(vlSelf->SingleCycleCPU__DOT__inst),32);
    bufp->fullIData(oldp+3,(vlSelf->SingleCycleCPU__DOT__readData1),32);
    bufp->fullIData(oldp+4,(vlSelf->SingleCycleCPU__DOT__readData2),32);
    bufp->fullIData(oldp+5,(vlSelf->SingleCycleCPU__DOT__imm),32);
    bufp->fullIData(oldp+6,(vlSelf->SingleCycleCPU__DOT__ALUSrcB),32);
    bufp->fullIData(oldp+7,((vlSelf->SingleCycleCPU__DOT__imm 
                             << 1U)),32);
    bufp->fullIData(oldp+8,(((IData)(4U) + vlSelf->SingleCycleCPU__DOT__pc_o)),32);
    bufp->fullIData(oldp+9,((vlSelf->SingleCycleCPU__DOT__pc_o 
                             + (vlSelf->SingleCycleCPU__DOT__imm 
                                << 1U))),32);
    bufp->fullCData(oldp+10,(vlSelf->SingleCycleCPU__DOT__opcode),7);
    bufp->fullCData(oldp+11,(vlSelf->SingleCycleCPU__DOT__rd),5);
    bufp->fullCData(oldp+12,(((0x80U <= vlSelf->SingleCycleCPU__DOT__pc_o)
                               ? 0U : (0x1fU & (vlSelf->__VdfgTmp_h9594e3d4__0 
                                                >> 0xfU)))),5);
    bufp->fullCData(oldp+13,(((0x80U <= vlSelf->SingleCycleCPU__DOT__pc_o)
                               ? 0U : (0x1fU & (vlSelf->__VdfgTmp_he45b3cba__0 
                                                >> 0x14U)))),5);
    bufp->fullCData(oldp+14,(vlSelf->SingleCycleCPU__DOT__ALUCtl),4);
    bufp->fullCData(oldp+15,(vlSelf->SingleCycleCPU__DOT__funct3),3);
    bufp->fullCData(oldp+16,(vlSelf->SingleCycleCPU__DOT__memtoReg),2);
    bufp->fullCData(oldp+17,(vlSelf->SingleCycleCPU__DOT__ALUOp),2);
    bufp->fullCData(oldp+18,(vlSelf->SingleCycleCPU__DOT__PCSel),2);
    bufp->fullBit(oldp+19,(vlSelf->SingleCycleCPU__DOT__memWrite));
    bufp->fullBit(oldp+20,(vlSelf->SingleCycleCPU__DOT__ALUSrc));
    bufp->fullBit(oldp+21,(vlSelf->SingleCycleCPU__DOT__regWrite));
    bufp->fullBit(oldp+22,((vlSelf->SingleCycleCPU__DOT__readData1 
                            == vlSelf->SingleCycleCPU__DOT__readData2)));
    bufp->fullBit(oldp+23,(vlSelf->SingleCycleCPU__DOT__BrLT));
    bufp->fullBit(oldp+24,(((0x80U > vlSelf->SingleCycleCPU__DOT__pc_o) 
                            & ((IData)(vlSelf->__VdfgTmp_h98940ace__0) 
                               >> 6U))));
    bufp->fullIData(oldp+25,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[0]),32);
    bufp->fullIData(oldp+26,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[1]),32);
    bufp->fullIData(oldp+27,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[2]),32);
    bufp->fullIData(oldp+28,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[3]),32);
    bufp->fullIData(oldp+29,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[4]),32);
    bufp->fullIData(oldp+30,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[5]),32);
    bufp->fullIData(oldp+31,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[6]),32);
    bufp->fullIData(oldp+32,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[7]),32);
    bufp->fullIData(oldp+33,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[8]),32);
    bufp->fullIData(oldp+34,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[9]),32);
    bufp->fullIData(oldp+35,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[10]),32);
    bufp->fullIData(oldp+36,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[11]),32);
    bufp->fullIData(oldp+37,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[12]),32);
    bufp->fullIData(oldp+38,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[13]),32);
    bufp->fullIData(oldp+39,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[14]),32);
    bufp->fullIData(oldp+40,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[15]),32);
    bufp->fullIData(oldp+41,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[16]),32);
    bufp->fullIData(oldp+42,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[17]),32);
    bufp->fullIData(oldp+43,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[18]),32);
    bufp->fullIData(oldp+44,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[19]),32);
    bufp->fullIData(oldp+45,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[20]),32);
    bufp->fullIData(oldp+46,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[21]),32);
    bufp->fullIData(oldp+47,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[22]),32);
    bufp->fullIData(oldp+48,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[23]),32);
    bufp->fullIData(oldp+49,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[24]),32);
    bufp->fullIData(oldp+50,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[25]),32);
    bufp->fullIData(oldp+51,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[26]),32);
    bufp->fullIData(oldp+52,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[27]),32);
    bufp->fullIData(oldp+53,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[28]),32);
    bufp->fullIData(oldp+54,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[29]),32);
    bufp->fullIData(oldp+55,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[30]),32);
    bufp->fullIData(oldp+56,(vlSelf->SingleCycleCPU__DOT__m_Register__DOT__regs[31]),32);
    bufp->fullIData(oldp+57,(vlSelf->SingleCycleCPU__DOT__pc_i),32);
    bufp->fullIData(oldp+58,(vlSelf->SingleCycleCPU__DOT__ALUOut),32);
    bufp->fullBit(oldp+59,(vlSelf->SingleCycleCPU__DOT__memRead));
    ...
    bufp->fullIData(oldp+95,(vlSelf->SingleCycleCPU__DOT__memData),32);
