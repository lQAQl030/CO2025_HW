    ...
    if (vlSelf->start) {
        if ((2U & vlSelf->PipelineCPU__DOT__EX_MEM[4U])) {
            ...
            vlSelf->__Vdlyvdim0__PipelineCPU__DOT__m_DataMemory__DOT__data_memory__v0 
                = (0x7fU & ((IData)(3U) + vlSelf->PipelineCPU__DOT____Vcellinp__m_Mux_BranchA__s1));
            ...
            vlSelf->__Vdlyvdim0__PipelineCPU__DOT__m_DataMemory__DOT__data_memory__v1 
                = (0x7fU & ((IData)(2U) + vlSelf->PipelineCPU__DOT____Vcellinp__m_Mux_BranchA__s1));
            ...
            vlSelf->__Vdlyvdim0__PipelineCPU__DOT__m_DataMemory__DOT__data_memory__v2 
                = (0x7fU & ((IData)(1U) + vlSelf->PipelineCPU__DOT____Vcellinp__m_Mux_BranchA__s1));
    ...
    if (vlSelf->start) {
        ...
        vlSelf->PipelineCPU__DOT__MEM_WB[4U] = (7U 
                                                & (vlSelf->PipelineCPU__DOT__EX_MEM[4U] 
                                                   >> 2U));
        vlSelf->PipelineCPU__DOT__EX_MEM[0U] = vlSelf->PipelineCPU__DOT____Vcellinp__m_EX_MEM__data_i[0U];
        vlSelf->PipelineCPU__DOT__EX_MEM[1U] = vlSelf->PipelineCPU__DOT____Vcellinp__m_EX_MEM__data_i[1U];
        vlSelf->PipelineCPU__DOT__EX_MEM[2U] = vlSelf->PipelineCPU__DOT____Vcellinp__m_EX_MEM__data_i[2U];
        vlSelf->PipelineCPU__DOT__EX_MEM[3U] = vlSelf->PipelineCPU__DOT____Vcellinp__m_EX_MEM__data_i[3U];
        vlSelf->PipelineCPU__DOT__EX_MEM[4U] = vlSelf->PipelineCPU__DOT____Vcellinp__m_EX_MEM__data_i[4U];
    } else {
