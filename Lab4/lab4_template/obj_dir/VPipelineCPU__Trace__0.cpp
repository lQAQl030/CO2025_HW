...
void VPipelineCPU___024root__trace_chg_sub_0(VPipelineCPU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        ...
        bufp->chgBit(oldp+42,(vlSelf->PipelineCPU__DOT__PCorR1));
        bufp->chgCData(oldp+43,(vlSelf->PipelineCPU__DOT__memtoReg),2);
        bufp->chgCData(oldp+44,(vlSelf->PipelineCPU__DOT__ALUOp),2);
        bufp->chgIData(oldp+45,(((0U == (3U & vlSelf->PipelineCPU__DOT__MEM_WB[4U]))
        ...
        bufp->chgIData(oldp+46,(vlSelf->PipelineCPU__DOT__imm),32);
        bufp->chgIData(oldp+47,(((IData)(vlSelf->PipelineCPU__DOT__PCorR1)
                                  ? vlSelf->PipelineCPU__DOT__imm
                                  : (vlSelf->PipelineCPU__DOT__imm 
                                     << 1U))),32);
        bufp->chgWData(oldp+48,(vlSelf->PipelineCPU__DOT__ID_EX),168);
        bufp->chgIData(oldp+54,(vlSelf->PipelineCPU__DOT__ALUSrcB),32);
        bufp->chgCData(oldp+55,(vlSelf->PipelineCPU__DOT__ALUCtl),4);
        bufp->chgIData(oldp+56,(vlSelf->PipelineCPU__DOT__ALUOut),32);
        ...
        bufp->chgCData(oldp+71,((7U & (vlSelf->PipelineCPU__DOT__ID_EX[0U] 
                                       >> 0xcU))),3);
        bufp->chgCData(oldp+72,((0x7fU & vlSelf->PipelineCPU__DOT__IF_ID[0U])),7);
        bufp->chgCData(oldp+73,((7U & (vlSelf->PipelineCPU__DOT__IF_ID[0U] 
                                       >> 0xcU))),3);
        bufp->chgBit(oldp+74,((1U & (vlSelf->PipelineCPU__DOT__EX_MEM[4U] 
                                     >> 1U))));
        bufp->chgIData(oldp+75,(vlSelf->PipelineCPU__DOT__EX_MEM[1U]),32);
        ...
        __Vtemp_h81081965__0[4U] = (0x1fU & (vlSelf->PipelineCPU__DOT__ID_EX[5U] 
                                             >> 3U));
        bufp->chgWData(oldp+76,(__Vtemp_h81081965__0),133);
        ...
        __Vtemp_he0585090__0[2U] = (IData)(((((QData)((IData)(
                                             ...
                                             | (QData)((IData)(vlSelf->PipelineCPU__DOT__pc_o))) 
                                            >> 0x20U));
        bufp->chgWData(oldp+81,(__Vtemp_he0585090__0),96);
        bufp->chgIData(oldp+84,(vlSelf->PipelineCPU__DOT__IF_ID[0U]),32);
        bufp->chgBit(oldp+85,((1U & vlSelf->PipelineCPU__DOT__ID_EX[5U])));
        bufp->chgIData(oldp+86,(vlSelf->PipelineCPU__DOT__ID_EX[2U]),32);
        bufp->chgIData(oldp+87,(vlSelf->PipelineCPU__DOT__ID_EX[1U]),32);
        bufp->chgCData(oldp+88,((3U & vlSelf->PipelineCPU__DOT__MEM_WB[4U])),2);
        bufp->chgIData(oldp+89,(vlSelf->PipelineCPU__DOT__MEM_WB[2U]),32);
        bufp->chgIData(oldp+90,(vlSelf->PipelineCPU__DOT__MEM_WB[1U]),32);
        bufp->chgIData(oldp+91,(vlSelf->PipelineCPU__DOT__MEM_WB[3U]),32);
        bufp->chgIData(oldp+92,(vlSelf->PipelineCPU__DOT__IF_ID[1U]),32);
    ...
    if (VL_UNLIKELY((vlSelf->__Vm_traceActivity[2U] 
        ...
        bufp->chgIData(oldp+102,(((1U & (IData)(vlSelf->PipelineCPU__DOT__PCSel))
        ...
        bufp->chgIData(oldp+103,(((IData)(vlSelf->PipelineCPU__DOT__PCorR1)
                                   ? vlSelf->PipelineCPU__DOT__readData1
                                   : vlSelf->PipelineCPU__DOT__IF_ID[1U])),32);
        bufp->chgIData(oldp+104,((((IData)(vlSelf->PipelineCPU__DOT__PCorR1)
                                    ? vlSelf->PipelineCPU__DOT__readData1
                                    : vlSelf->PipelineCPU__DOT__IF_ID[1U]) 
                                  + ((IData)(vlSelf->PipelineCPU__DOT__PCorR1)
                                      ? vlSelf->PipelineCPU__DOT__imm
        ...
        bufp->chgWData(oldp+105,(__Vtemp_hf6116a8c__0),168);
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[4U])) {
        bufp->chgBit(oldp+111,(vlSelf->PipelineCPU__DOT__BrEq));
        bufp->chgBit(oldp+112,(vlSelf->PipelineCPU__DOT__BrLT));
        bufp->chgBit(oldp+113,(vlSelf->PipelineCPU__DOT__Flush_ctrl));
        bufp->chgCData(oldp+114,(vlSelf->PipelineCPU__DOT__PCSel),2);
        bufp->chgIData(oldp+115,(vlSelf->PipelineCPU__DOT__readData1),32);
        bufp->chgIData(oldp+116,(vlSelf->PipelineCPU__DOT__readData2),32);
        bufp->chgBit(oldp+117,((1U & (IData)(vlSelf->PipelineCPU__DOT__PCSel))));
    }
    bufp->chgBit(oldp+118,(vlSelf->clk));
    bufp->chgBit(oldp+119,(vlSelf->start));
    bufp->chgIData(oldp+120,(vlSelf->r[0]),32);
    bufp->chgIData(oldp+121,(vlSelf->r[1]),32);
    bufp->chgIData(oldp+122,(vlSelf->r[2]),32);
    bufp->chgIData(oldp+123,(vlSelf->r[3]),32);
    bufp->chgIData(oldp+124,(vlSelf->r[4]),32);
    bufp->chgIData(oldp+125,(vlSelf->r[5]),32);
    bufp->chgIData(oldp+126,(vlSelf->r[6]),32);
    bufp->chgIData(oldp+127,(vlSelf->r[7]),32);
    bufp->chgIData(oldp+128,(vlSelf->r[8]),32);
    bufp->chgIData(oldp+129,(vlSelf->r[9]),32);
    bufp->chgIData(oldp+130,(vlSelf->r[10]),32);
    bufp->chgIData(oldp+131,(vlSelf->r[11]),32);
    bufp->chgIData(oldp+132,(vlSelf->r[12]),32);
    bufp->chgIData(oldp+133,(vlSelf->r[13]),32);
    bufp->chgIData(oldp+134,(vlSelf->r[14]),32);
    bufp->chgIData(oldp+135,(vlSelf->r[15]),32);
    bufp->chgIData(oldp+136,(vlSelf->r[16]),32);
    bufp->chgIData(oldp+137,(vlSelf->r[17]),32);
    bufp->chgIData(oldp+138,(vlSelf->r[18]),32);
    bufp->chgIData(oldp+139,(vlSelf->r[19]),32);
    bufp->chgIData(oldp+140,(vlSelf->r[20]),32);
    bufp->chgIData(oldp+141,(vlSelf->r[21]),32);
    bufp->chgIData(oldp+142,(vlSelf->r[22]),32);
    bufp->chgIData(oldp+143,(vlSelf->r[23]),32);
    bufp->chgIData(oldp+144,(vlSelf->r[24]),32);
    bufp->chgIData(oldp+145,(vlSelf->r[25]),32);
    bufp->chgIData(oldp+146,(vlSelf->r[26]),32);
    bufp->chgIData(oldp+147,(vlSelf->r[27]),32);
    bufp->chgIData(oldp+148,(vlSelf->r[28]),32);
    bufp->chgIData(oldp+149,(vlSelf->r[29]),32);
    bufp->chgIData(oldp+150,(vlSelf->r[30]),32);
    bufp->chgIData(oldp+151,(vlSelf->r[31]),32);
    bufp->chgIData(oldp+152,(vlSelf->PipelineCPU__DOT__memData),32);
    bufp->chgBit(oldp+153,(vlSelf->PipelineCPU__DOT____Vcellinp__m_DataMemory__memRead));
    bufp->chgIData(oldp+154,(vlSelf->PipelineCPU__DOT____Vcellinp__m_DataMemory__address),32);
}
