...
class VPipelineCPU___024root final : public VerilatedModule {
  public:
    ...
    IData/*31:0*/ PipelineCPU__DOT__BranchA;
    IData/*31:0*/ PipelineCPU__DOT__BranchB;
    IData/*31:0*/ PipelineCPU__DOT____Vcellinp__m_Mux_BranchA__s1;
    IData/*31:0*/ PipelineCPU__DOT__imm;
    VlWide<6>/*167:0*/ PipelineCPU__DOT__ID_EX;
    IData/*31:0*/ PipelineCPU__DOT__ForwardA;
    IData/*31:0*/ PipelineCPU__DOT__ForwardB;
    IData/*31:0*/ PipelineCPU__DOT__ALUSrcB;
    VlWide<5>/*132:0*/ PipelineCPU__DOT__EX_MEM;
    VlWide<5>/*132:0*/ PipelineCPU__DOT____Vcellinp__m_EX_MEM__data_i;
    IData/*31:0*/ PipelineCPU__DOT__memData;
    VlWide<5>/*130:0*/ PipelineCPU__DOT__MEM_WB;
    IData/*31:0*/ __VstlIterCount;
    IData/*31:0*/ __Vtrigrprev__TOP__PipelineCPU__DOT____Vcellinp__m_Mux_BranchA__s1;
